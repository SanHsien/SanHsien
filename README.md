...
| Delivery / 交付流程 | [agent-cortex](https://github.com/SanHsien/agent-cortex) | Candidate, verification, independent review, completion evidence ｜候選、驗證、獨立審查與完成證據 |
...
| **Agent skills**<br>Agent 技能包 | [agent-skills](https://github.com/SanHsien/agent-skills) spec→ship flow ｜工程流程 · [agent-astromech](https://github.com/SanHsien/agent-astromech) cross-model review ｜跨模型二審 · [book-to-skill](https://github.com/SanHsien/book-to-skill) books as skills ｜技術書轉技能 | [all →](https://github.com/SanHsien?tab=repositories&q=topic%3Aagent-skills&type=public) |
