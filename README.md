...
Some work is private or context-specific, so I only summarize the general shape: internal workflow tools, inventory and sales workflow systems, mobile field-record apps, office automation, and maintenance handover documents.  
部分工作屬於私人或特定場域用途，因此只概略描述能力範圍：內部流程工具、進銷存與銷售流程系統、行動端現場紀錄程式、辦公自動化，以及維護交接文件。
